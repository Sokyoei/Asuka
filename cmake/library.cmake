...
if(FFMPEG_FOUND)
    set(ASUKA_USE_FFMPEG true)
    message(STATUS "FFMPEG libraries: ${FFMPEG_LIBRARIES}")
    message(STATUS "FFMPEG include directories: ${FFMPEG_INCLUDE_DIRS}")
    message(STATUS "FFMPEG library directories: ${FFMPEG_LIBRARY_DIRS}")
endif(FFMPEG_FOUND)
...
if(realsense2_FOUND)
    set(ASUKA_USE_REALSENSE2 true)
endif(realsense2_FOUND)

find_package(glad CONFIG)
# target_link_libraries(main PRIVATE glad::glad)
if(glad_FOUND)
    set(ASUKA_USE_GLAD true)
endif(glad_FOUND)

find_package(glfw3 CONFIG)
# target_link_libraries(main PRIVATE glfw)
if(glfw3_FOUND)
    set(ASUKA_USE_GLFW3 true)
endif(glfw3_FOUND)

find_package(imgui CONFIG)
# target_link_libraries(main PRIVATE imgui::imgui)
if(imgui_FOUND)
    set(ASUKA_USE_IMGUI true)
endif(imgui_FOUND)

find_package(OpenCV CONFIG)
if(OpenCV_FOUND)
    set(ASUKA_USE_OPENCV true)
endif(OpenCV_FOUND)

if(CMAKE_CUDA_COMPILER)
    find_package(CUDAToolkit REQUIRED)
    set(ASUKA_USE_CUDATOOLKIT true)
endif(CMAKE_CUDA_COMPILER)

if(PkgConfig_FOUND)
    pkg_check_modules(GSTREAMER gstreamer-1.0 gstreamer-base-1.0 gstreamer-video-1.0)
    if(GSTREAMER_FOUND)
        set(ASUKA_USE_GSTREAMER true)
...
find_package(Eigen3)
if(Eigen3_FOUND)
    set(ASUKA_USE_EIGEN3 true)
endif(Eigen3_FOUND)

find_package(PCL COMPONENTS common io visualization filters kdtree)
if(PCL_FOUND)
    set(ASUKA_USE_PCL true)
...
if(ONNXRuntime)
    if(ONNXRuntime_CMAKE_DIR)
        ...
        if(onnxruntime_FOUND)
            set(ASUKA_USE_ONNXRUNTIME true)
